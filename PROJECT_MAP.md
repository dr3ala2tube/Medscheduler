...
- **M17 — Conflict scope v2: leave-day + post-call rest** (L1: index.html only; no API/schema/rules change; warn + override per D11)
...
- **M18 — Dark & light themes** (L1: index.html only)
